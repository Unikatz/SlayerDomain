...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) ERC721 ("Dslayer Name Service", "DNS") payable {
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the DSlayer name service", "image": "data:image/svg+xml;base64,',
