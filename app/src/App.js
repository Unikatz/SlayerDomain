...
const tld = '.dslayer';
const CONTRACT_ADDRESS = '0xd7e27D70Cc8BE63A9Ad0B01F6B7E5f9CAD07a2D2';
...
      <img src="https://media.giphy.com/media/QUKqSLmE7vmZP2PkZk/giphy.gif" alt="slayer gif" />
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
              <p className="title">🗡 Dslayer Name Service🗡</p>
              <p className="subtitle">Your immutable API on the blockchain!</p>
						</div>
